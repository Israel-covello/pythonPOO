...
cliente1 = Cliente('Cliente1', 25)
cliente2 = Cliente('Cliente2', 30)
cliente3 = Cliente('Cliente3', 20)

conta1 = ContaPoupanca(1111, 102030, 0)
conta2 = ContaCorrente(2222, 302010, 0)
conta3 = ContaCorrente(1212, 203010, 0)
